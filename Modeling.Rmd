...
mydata <- data %>% 
  ...
  select(treatment, factcheck, 
         ...
         edu)
```
I add three variables: age, gender, edu. I want will test if each of them have some contribution in "trust in health experts".
...
model42.aov <- aov(Crespon2 ~ treatment + 
                ...
                treatment * factcheck + 
                treatment * defense + 
                treatment * racism+treatment * edu,
              data = model4_2.data)
...
TukeyHSD(model52.aov,which='edu') 
